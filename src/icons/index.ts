...
import { ReactComponent as InfoWhiteIcon } from './info-w.svg?react';
...
import { ReactComponent as SmileIcon } from './smile.svg?react';
...
import { ReactComponent as AtSignIcon } from './at-sign.svg?react';
...
import { ReactComponent as CirclCheckIcon } from './circle-check.svg?react';
import { ReactComponent as MegaPhoneIcon } from './megaphone.svg?react';
import { ReactComponent as User2Icon } from './user.svg?react';
import { ReactComponent as UsersIcon } from './users.svg?react';
import { ReactComponent as PinOffIcon } from './pin-off.svg?react';
